...
export async function GET_COMMUNITY_DETAILS(communityId: string) {
  try {
    await connectToDB();
...
export async function REMOVE_MEMBER(memberId: string, communityId: string) {
  try {
    await connectToDB();
...
export async function UPDATE_COMMUNITY(
  communityId: string,
  name: string,
  username: string,
  image: string
...
export async function DELETE_COMMUNITY(communityId: string) {
  try {
    await connectToDB();
